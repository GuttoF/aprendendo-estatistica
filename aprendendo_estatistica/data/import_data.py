...
def load_data():
    ...
    data.columns = ['escola', 'sexo', 'idade', 'tipo_de_endereço', 'tamanho_da_familia',
                    ...
                    'motivo_para_escolher_escola', 'guardião_do_aluno', 'tempo_para_ir_à_escola',
                    ...
                    'possui_relacionamento_romântico', 'qualidade_das_relações_familiares',
    ...
    data['motivo_para_escolher_escola'] = data['motivo_para_escolher_escola'].replace('home', 'proximidade da casa')
    data['motivo_para_escolher_escola'] = data['motivo_para_escolher_escola'].replace('reputation', 'reputação')
    data['motivo_para_escolher_escola'] = data['motivo_para_escolher_escola'].replace('course', 'curso')
    data['motivo_para_escolher_escola'] = data['motivo_para_escolher_escola'].replace('other', 'outro')
